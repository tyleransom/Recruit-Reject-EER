...
text(1989.0,6.0 ,'Share of Applicants');
text(1995.0,10.2,'Share of Admits');
...
saveas(gcf,'../FiguresAndTables/bigAppAdmShrAfrAm','eps');
print -dpdf -painters ../FiguresAndTables/bigAppAdmShrAfrAm
