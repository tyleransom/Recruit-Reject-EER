function topadmallyearmath(X1, YMatrix1, objname)
...
text(2011,30,'Hispanic');
text(2011,18.5,'White');
text(2012,12,'Asian American');
ylabel({'Admit rate (%)'});
...
saveas(gcf,'../FiguresAndTables/topScoringAdmRateAll','eps');
print('-dpdf','-painters','../FiguresAndTables/topScoringAdmRateAll');
