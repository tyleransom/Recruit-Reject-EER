...
if strcmpi(objname(end-2:end),'app')
    text(2014.5,850,'Writing<550');
    text(2014,385 ,'Writing 550-590');
    text(2012.5,520,'Writing 600-640');
    text(2013.8,1010,'Writing>640');
    ylabel({'Number of Applicants'});
else
    text(2012.0,65  ,'Writing<550');
    annotation('arrow',[0.5 0.5],[0.25 0.12]);
    text(2010  ,15,'Writing 550-590');
    text(2010, 40,'Writing 600-640');
    text(2012, 185 ,'Writing>640');
