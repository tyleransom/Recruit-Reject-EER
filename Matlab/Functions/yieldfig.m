...
text(2004,72.6,'Hispanic');
text(2003,64.1,'African American');
text(2012,84.2,'Asian American');
text(2010,75.4,'White');
...
print -dpdf -painters ../FiguresAndTables/yield

saveas(gcf,'../FiguresAndTables/yield','eps');
