...
if strcmpi(objname(end-2:end),'app')
    text(2012.5,510,'Verbal<550');
    text(2013,350 ,'Verbal 550-590');
    text(2012.5,600,'Verbal 600-640');
    text(2010.0,1070,'Verbal>640');
    ylabel({'Number of Applicants'});
else
    text(2012.0,65  ,'Verbal<550');
    annotation('arrow',[0.5 0.5],[0.35 0.11]);   %annotation('arrow',[0.5 0.5],[0.35 0.12]);
    text(2010  ,10,'Verbal 550-590');
    text(2013.5, 30,'Verbal 600-640');
    text(2011.5, 185 ,'Verbal>640');
