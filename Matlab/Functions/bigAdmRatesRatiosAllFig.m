...
text(1995,1.8,'African American');
text(1990,1.45,'Hispanic');
text(1986,0.9,'Asian American');
text(2012.4,1.3,'White');
...
print -dpdf -painters ../FiguresAndTables/bigAdmRatesRatiosAll
saveas(gcf,'../FiguresAndTables/bigAdmRatesRatiosAll','eps');
