...
if strcmpi(objname(end-2:end),'app')
    text(2014.5,820,'Math<550');
    text(2014,395 ,'Math 550-590');
    text(2012.5,520,'Math 600-640');
    text(2013.8,1000,'Math>640');
    ylabel({'Number of Applicants'});
else
    text(2012.0,65  ,'Math<550');
    annotation('arrow',[0.5 0.5],[0.35 0.12]);
    text(2010  ,20,'Math 550-590');
    text(2010, 40,'Math 600-640');
    text(2012, 185 ,'Math>640');
