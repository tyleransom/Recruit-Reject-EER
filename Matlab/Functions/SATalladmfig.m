...
text(2011.5,700,'African American');
text(2007.7,722,'Hispanic');
text(2011.5,771,'Asian American');
text(2007.7,752,'White');
...
print -dpdf -painters ../FiguresAndTables/SATalladm
saveas(gcf,'../FiguresAndTables/SATalladm','eps');
