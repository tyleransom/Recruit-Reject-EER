function shrG750year(X1, YMatrix1)
...
% Create ylabel
text(2011.5,43,'Asian American');
text(2012.5,2.5,'African American');
text(2011,4.5 ,'Hispanic');
text(2010,40.5,'White');
...
saveas(gcf,'../FiguresAndTables/shrG750','eps');
print('-dpdf','-painters','../FiguresAndTables/shrG750');
