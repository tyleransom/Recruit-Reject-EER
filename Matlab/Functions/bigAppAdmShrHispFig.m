...
text(2000.0,5.5 ,'Share of Applicants');
text(1999.0,9.5,'Share of Admits');
...
saveas(gcf,'../FiguresAndTables/bigAppAdmShrHisp','eps');
print -dpdf -painters ../FiguresAndTables/bigAppAdmShrHisp
